...
function App() {
  ...
  return (
    <div className="gradient-bg">
      ...
      {/* Header */}
      <header
        className={`fixed w-full glass z-50 transition-all duration-300 ${scrollY > 50 ? "py-2 bg-opacity-30" : "py-4 bg-opacity-10"}`}
      >
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            >
              <span className="flex items-center">
                Sign In <Star className="w-4 h-4 ml-2 sparkle" />
              </span>
            </button>
          </div>
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden glass p-4 animate-fadeIn">
            <div className="flex flex-col space-y-4">
              <button
                onClick={() => scrollToSection("showcase")}
                className="text-left px-2 py-2 transition-all hover:pl-4 hover:text-purple-600"
              >
      ...
      >
        <div className="container mx-auto text-center z-10 py-20">
          <div className="relative">
            ...
            <Star
              className="absolute top-0 right-0 w-8 h-8 text-pink-400 opacity-70 sparkle"
              style={{ animationDelay: "0.5s" }}
            />
            <Star
              className="absolute bottom-0 left-10 w-6 h-6 text-purple-400 opacity-60 sparkle"
      ...
      <section id="showcase" className="py-32 px-6 relative">
        <div className="container mx-auto">
          <h2 className="section-title">Showcase Your Creative Vision</h2>
            ...
            {[
              {
                ...
                image: 1,
                quote:
                  "Just Vibing helped me showcase my digital art to a global audience and connect with amazing collaborative opportunities.",
                delay: 0,
              },
              {
                name: "Samira Chen",
                ...
                image: 2,
                quote:
                  "Within weeks of joining, I connected with other musicians and landed my first major production contract. The exposure is incredible!",
                delay: 200,
              },
              {
                name: "Jordan Taylor",
                ...
                image: 3,
                quote:
                  "The platform's intuitive design makes it so easy to highlight my best work and reach people who truly appreciate my creative style.",
                delay: 400,
              },
            ].map((creator, i) => (
              <div
                key={i}
                className={`glass-card rounded-xl p-6 shadow-lg fade-in delay-${creator.delay}`}
              >
                ...
                <p className="text-gray-700 italic">"{creator.quote}"</p>
      ...
      <section id="features" className="py-32 px-6 relative">
        <div className="container mx-auto">
          <h2 className="section-title">Powerful Features for Creators</h2>
            ...
            {[
              {
                ...
                description:
                  "Our user-friendly interface makes showcasing your work effortless, allowing you to focus on what matters most: your creativity.",
                delay: 0,
              },
              {
                ...
                description:
                  "Connect with like-minded creators, collaborate on projects, and expand your network across borders and disciplines.",
                delay: 200,
              },
              {
                ...
                description:
                  "Gain access to unique projects, funding opportunities, and partnerships available only to our vibrant community members.",
                delay: 400,
              },
            ].map((feature, i) => (
              <div
                key={i}
                className={`glass-card rounded-xl p-8 text-center fade-in delay-${feature.delay} group hover:transform hover:translate-y-[-10px] transition-all duration-300`}
              >
              ...
              {[
                {
                  ...
                  description:
                    "Sign up and build your personalized creator profile in minutes. Highlight your skills, showcase your portfolio, and tell your unique story.",
                ...
                },
                {
                  ...
                  description:
                    "Share your creative projects with our community. Our platform supports various media formats to perfectly showcase your talents.",
                ...
                },
                {
                  ...
                  description:
                    "Engage with fellow creators, receive feedback, and discover collaboration opportunities that align with your creative vision.",
                ...
                },
                {
                  ...
                  description:
                    "Expand your reach through our global network. Gain visibility with potential clients, partners, and fans who appreciate your work.",
                ...
                <div
                  key={i}
                  className={`flex flex-col ${step.align === "left" ? "md:flex-row" : "md:flex-row-reverse"} items-center fade-in delay-${step.delay}`}
                >
                  <div
                    className={`md:w-1/2 ${step.align === "left" ? "md:pr-16 md:text-right" : "md:pl-16"}`}
                  >
                    <div className="mb-4 text-5xl font-extrabold text-gray-200">
                      {step.number}
                    </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div
                key={i}
                className={`glass-card rounded-xl p-6 shadow-lg fade-in delay-${(i % 3) * 200}`}
              >
                <div className="flex items-center space-x-4 mb-6">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 shadow-lg flex items-center justify-center overflow-hidden">
                ...
                <p className="text-gray-700">
                  "Thanks to Just Vibing, I was able to connect with{" "}
                  {i % 2 === 0 ? "industry professionals" : "other creators"}{" "}
                  and{" "}
                  {i % 3 === 0
                    ? "secure my dream project"
                    : i % 3 === 1
                      ? "build my brand"
                      : "expand my audience"}{" "}
        ...
        <div className="container mx-auto text-center">
          <div className="glass-card rounded-2xl p-12 max-w-4xl mx-auto fade-in">
            ...
            <p className="text-xl text-gray-700 mb-10 max-w-2xl mx-auto">
              Join thousands of creators already thriving in our community. Your
      ...
      <footer className="py-16 px-6 relative">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-10">
            <div>
              ...
              <p className="text-gray-700 mb-6">
                Where creative vision meets opportunity. Join our vibrant
                community today.
              </p>
          ...
          <div className="border-t border-gray-200 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600">
              &copy; {new Date().getFullYear()} Just Vibing. All rights
              reserved.
            </p>
          ...
          <div className="glass-card rounded-xl p-8 max-w-md w-full mx-4 fade-in">
            <div className="flex justify-between mb-6">
              <h2 className="text-2xl font-bold gradient-text">
                {authTab === "signin" ? "Welcome Back" : "Join Our Community"}
              </h2>
              <button
            ...
            {authTab === "signin" ? (
              <div className="space-y-5 fade-in">
                ...
                <div className="flex justify-between items-center text-sm">
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                      className="rounded text-purple-500 mr-2"
                    />
                    Remember me
                  </label>
                  <a
              ...
              <div className="space-y-5 fade-in">
                ...
                <button className="w-full gradient-button py-3">
                  Create Account
                </button>
